...
Individual_Analysis_Results_Summary <- function(agds_dir,jobs_num,input_path,output_path,
                                                chromosome,
                                                ...
                                                alpha=5E-08,manhattan_plot=FALSE,QQ_plot=FALSE,
  ...
  num <- 0
  for(chr in chromosome:chromosome)
  {
    ...
    for(kk in 1:jobs_num$individual_analysis_num)
    {
      job_id <- 1
      results_individual_analysis <- get(load(paste0(input_path,individual_results_name,".Rdata")))
  ...
  # save results
  # save(results_individual_analysis_genome,file=paste0(output_path,"results_individual_analysis.Rdata"))
  ## Significant findings
  results_sig <- results_individual_analysis_genome[results_individual_analysis_genome$pvalue<alpha,]
  print(dim(results_sig))
  # save significant results
  saveRDS(results_sig, paste0(output_path,"results_individual_analysis_sig.RDS"))
  ...
  if(length(known_loci)!=0)
  {
    if(!use_SPA)
    {
      ...
      saveRDS(results_sig_cond, paste0(output_path, "results_sig_cond.RDS"))
    ...
    }else
    {
      ...
      saveRDS(results_sig_cond, paste0(output_path,"results_individual_analysis_sig_cond.RDS"))
      #write.csv(results_sig_cond,paste0(output_path,"results_sig_cond.csv"))
    }
